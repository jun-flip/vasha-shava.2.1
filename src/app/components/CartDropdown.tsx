      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-[64px] left-0 right-0 mx-auto w-full max-w-[95vw] h-[80vh] bg-white rounded-lg shadow-xl z-50 flex flex-col sm:left-auto sm:right-4 sm:w-[350px] md:w-[500px]"
          >
